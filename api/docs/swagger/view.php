...
Bearer auth: <input id="input_bearer" class="body-param__text">
  ...
  window.onload = function () {
    ...
    window.setExtraHeader = function (sessionId) {
      ...
      system.fn.fetch = function (obj) {
        ...
        obj.headers['Authorization'] = "Bearer " + sessionId
    ...
    function setAuthHeader (header) {
      window.setExtraHeader(header)
    }
    var token = window.localStorage.getItem('bearer')
    $('#input_bearer').val(token)
    setAuthHeader(token)
    $('#input_bearer').change(function (input) {
      var token = $('#input_bearer').val()
      console.log(token)
